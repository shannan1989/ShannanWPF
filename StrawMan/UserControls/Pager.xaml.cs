...
namespace Shannan.StrawMan.UserControls
{
    public partial class Pager : UserControl
    {
        ...
        public Pager()
        {
            ...
            PART_FirstButton.Click += delegate
            {
                CurrentPage = 1;
                RefreshLayout();
                RaiseEvent();
            ...
            PART_LastButton.Click += delegate
            {
            ...
            PART_PreviousButton.Click += delegate
            {
                CurrentPage -= 1;
            ...
            PART_NextButton.Click += delegate
            {
                CurrentPage += 1;
        ...
        public static readonly DependencyProperty TotalProperty = DependencyProperty.Register("Total", typeof(int), typeof(Pager), new PropertyMetadata(0, TotalChanged));
        ...
        public static readonly DependencyProperty PageSizeProperty = DependencyProperty.Register("PageSize", typeof(int), typeof(Pager), new PropertyMetadata(0, PageSizeChanged));
        ...
        public static readonly DependencyProperty PageCountProperty = DependencyProperty.Register("PageCount", typeof(int), typeof(Pager), new PropertyMetadata(0, PageCountChanged));
        ...
        public static readonly DependencyProperty CurrentPageProperty = DependencyProperty.Register("CurrentPage", typeof(int), typeof(Pager), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty ShowNumberProperty = DependencyProperty.Register("ShowNumber", typeof(int), typeof(Pager), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty IsShowWhenEmptyProperty = DependencyProperty.Register("IsShowWhenEmpty", typeof(bool), typeof(Pager), new PropertyMetadata(false));
